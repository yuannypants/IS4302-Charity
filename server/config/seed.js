...
.then(() => console.log("\x1b[35m%s\x1b[0m","  Seeding CharitableOrganisation..."))
.then(() => db.ref('CharitableOrganisation/201912345A').set({organisationName: 'Community Chest',password: 'passworda',beneficiaries: ['201954321A','201954321B'],suppliers: []}, firebaseError => {if (firebaseError) console.log('Failed to create CharitableOrganisation: 201912345A'); else console.log('    Seeded CharitableOrganisation: 201912345A')}))
.then(() => db.ref('CharitableOrganisation/201912345B').set({organisationName: 'Singapore Red Cross',password: 'passwordb',beneficiaries: ['201954321B','201954321C'],suppliers: []}, firebaseError => {if (firebaseError) console.log('Failed to create CharitableOrganisation: 201912345B'); else console.log('    Seeded CharitableOrganisation: 201912345B')}))
.then(() => db.ref('CharitableOrganisation/201912345C').set({organisationName: 'Club Rainbow',password: 'passwordc',beneficiaries: ['201954321C','201954321A'],suppliers: []}, firebaseError => {if (firebaseError) console.log('Failed to create CharitableOrganisation: 201912345C'); else console.log('    Seeded CharitableOrganisation: 201912345C')}))
.then(() => db.ref('CharitableOrganisation/201912345D').set({organisationName: 'Hope Centre Singapore',password: 'passwordd',beneficiaries: ['201954321A','201954321B','201954321C'],suppliers: []}, firebaseError => {if (firebaseError) console.log('Failed to create CharitableOrganisation: 201912345D\n'); else console.log('    Seeded CharitableOrganisation: 201912345D')}))
