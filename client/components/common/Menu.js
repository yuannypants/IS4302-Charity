    ...
    let items = this.props.items && this.props.items.map((item, i) => {
      ...
      return (
        <li className={styleClass} key={i}>
          ...
          <Submenu items={item.items} onMenuItemClick={this.props.onMenuItemClick}/>
        </li>
      );
    });
...
export class Menu extends Component {
  ...
  render() {
    return <div className="menu"><Submenu items={this.props.model} className="layout-main-menu" onMenuItemClick={this.props.onMenuItemClick} root={true}/></div>
  }
}