                ...
                <table cellPadding="10" width="100%">
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        <ListBox value={this.state.selectedSuppliers} options={this.state.suppliers} onChange={(e) => this.setState({ selectedSuppliers: e.value })} multiple={true} optionLabel="SupplierId" />
                      </td>
                    </tr>
                    <tr>
                      <td colSpan='2'>
